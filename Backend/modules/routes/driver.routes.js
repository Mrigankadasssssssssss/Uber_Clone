...
routes.post('/register',[
    ...
    body('vehicle.capacity').isInt({ min: 2 }).withMessage('Capacity must be at least 2'),
...
// routes.get('/profile', authMiddleware, driverController.getDriverProfile);

// // Driver Logout Route
// routes.post('/logout', authMiddleware, driverController.logoutDriver);
