...
const ConfirmRides = (props) => {
  return (
    <div>
      ...
      <h3 className="mt-2.5 text-2xl font-semibold ">Confirm Your Ride</h3>
      <div className="flex gap-2 flex-col justify-between items-center">
        ...
        <button
          onClick={() => {
            props.setDriverFound(true), props.setConfirmRidePannel(false);
          }}
          className="w-full bg-green-600 text-white text-xl font-semibold p-3 rounded-lg hover:bg-green-400"
        >
          Confirm
        </button>
      </div>
